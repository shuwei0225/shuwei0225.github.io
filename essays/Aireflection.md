...
### 13. **Quality Assurance (Debugging, ESLint)**  
...
- Helped redesign UI text to sound more professional  
- Helped write GitHub Issues and commit messages  
- Helped format YAML front matter for essays  
- Helped understand bootstrap/grid layout  
**Usefulness:** High.
...
- **Run & Route Hub final project** (debugging, documentation, feature design)
- **HACC-style projects** to generate templates and test ideas quickly
- **Job applications** (resume improvements, cover letter drafts)
- **Business tasks** (writing customer emails, API error explanations)
...
### Challenges  
- AI sometimes produces incorrect or outdated code  
- Hard to rely on AI for WODs due to time constraints  
- Must avoid overdependence and maintain personal skill growth  
- AI explanations sometimes oversimplify important details  

### Opportunities  
- AI-powered debugging inside VS Code  
- Automated code review and comment suggestions  
- Faster onboarding for new frameworks  
- More personalized learning tools for future ICS students
...
**Traditional methods:**  
- Build deeper foundational knowledge  
- Help develop persistence and problem-solving discipline  

**AI-enhanced methods:**  
- Faster, more interactive, adaptive feedback  
- Immediate examples and debugging assistance  
- Great for visual learners and second-language learners  
...
- More AI-generated boilerplate code  
- AI-assisted refactoring  
- Real-time explainer tools inside IDEs  
- Personalized tutors for every student  
